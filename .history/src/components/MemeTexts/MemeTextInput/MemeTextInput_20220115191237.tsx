...
//typse
import {MemeWrapperRect} from "../../../redux/features/memeContainer/memeContainerSlice"

function MemeTextInput({ textId, value,curPosition }: { textId: string; value: string;curPosition:MemeWrapperRect }) {
  //redux
