...
function MemeContainer() {
  ...
  function handleDrag(e: any) {
    ...
    e.target.style.top = Number(e.clientY) - mouseOffset.y + "px";
    console.log(Number(e.clientY));
    console.log(Number(e.clientY) - mouseOffset.y + "px");
    e.target.style.left = Number(e.clientX) - mouseOffset.x + "px";
  }
