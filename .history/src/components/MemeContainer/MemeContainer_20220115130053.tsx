...
function MemeContainer() {
  ...
  //refr
  const memeCintaienrRef = useRef<HTMLDivElement>(null)
  ...
  function handleDragEnd(e: any, tId: string) {
    ...
    if (dragText != null) {
      ...
      dragText.style.left = `${
        dragText.getBoundingClientRect().left + e.clientX - mouseClients?.mouseX
      }px`;
      dragText.style.top = `${
        dragText.getBoundingClientRect().top + e.clientY - mouseClients?.mouseY
      }px`;
    }
