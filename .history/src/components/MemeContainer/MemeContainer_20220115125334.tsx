...
function MemeContainer() {
  ...
  const [mouseClients, setMouseClients] = useState<mouseClients>({mouseX:0,mouseY:0});
  ...
  function handleDragEnd(e: any, tId: string) {
    ...
    if (dragText != null) {
      ...
      dragText.style.left = `${dragText.getBoundingClientRect().left+ e.clientX - mouseClients?.mouseX}px`;
      dragText.style.top = `${dragText.getBoundingClientRect().left+ e.clientY - mouseClients?.mouseY}px`;
    }
