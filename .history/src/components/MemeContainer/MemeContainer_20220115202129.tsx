...
function MemeContainer() {
  ...
  function handleDragEnd(e: any, textData:{tId:string; top: number; left: number}) {

    const {tId,top}=textData;
    ...
    const top =  e.clientY - mouseClients.mouseY;
    const left = e.clientX - mouseClients.mouseX;
    updateTextField({});
    if (dragText != null) {
