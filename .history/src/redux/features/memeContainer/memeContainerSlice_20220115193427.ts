...
const initialState: { selectedMemeId: string; memesList: SingleMeme[],memeWrapperRect?:MemeWrapperRect } = {
  selectedMemeId: "",
  memesList: [],
...
export const memeContainerSlice = createSlice({
  ...
  reducers: {
    ...
    addTextField: (state) => {
      ...
      const defaultText: Text = { id: uuidv4(), value: "",top:state.memeWrapperRect?.top, left:state.memeWrapperRect?.left };
